...
# 'btn_click' function continuously updates the input field whenever you enter a number
def btn_click(item):
    global expression
...
input_field.pack(ipady=10)  # 'iPad-y' is internal padding to increase the height of input field
